...
# --- Форматирование сообщения с переводом, без ограничения и с улучшенным оформлением ---
def format_event_message(events, event_type="active"):
    """Форматирует список событий в текстовое сообщение с переводом, эмодзи и улучшенным оформлением."""
    if not events:
    ...
    for event in events:
        ...
        if event_type == "active":
            # Используем жирный шрифт для названия и локации
